...
#define xor_4k(i,ap,t,r) gf_mulx8_bl(r); xor_block_aligned(r, r, t[ap[15-i]])
...
#define xor_256(i,ap,t,r)    \
    gf_mulx4_bl(r); xor_block_aligned(r, r, t[ap[15 - i] >> 4]);  \
    gf_mulx4_bl(r); xor_block_aligned(r, r, t[ap[15 - i] & 15])
