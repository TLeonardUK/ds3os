...
#define xor_4k(i,ap,t,r) gf_mulx8_ll(r); xor_block_aligned(r, r, t[ap[i]])
...
#define xor_256(i,ap,t,r)    \
    gf_mulx4_ll(r); xor_block_aligned(r, r, t[ap[i] >> 4]);  \
    gf_mulx4_ll(r); xor_block_aligned(r, r, t[ap[i] & 0x0f])
