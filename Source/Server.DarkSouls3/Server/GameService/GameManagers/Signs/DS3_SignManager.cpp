...
bool DS3_SignManager::CanMatchWith(const DS3_Frpg2RequestMessage::MatchingParameter& Host, const DS3_Frpg2RequestMessage::MatchingParameter& Match, bool IsRedSign)
{
